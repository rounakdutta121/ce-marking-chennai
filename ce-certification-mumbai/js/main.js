(() => {
  ...
  const products = {
    machinery: {
      ...
      text: "Mumbai and the surrounding industrial region contain a significant base of engineering and manufacturing companies. If you plan to export machinery to Europe, identifying applicable safety requirements and standards should be one of the first steps.",
      items: [
    ...
    electrical: {
      ...
      text: "Depending on the product, requirements relating to electrical safety, EMC, RoHS, radio equipment, machinery safety or other European legislation may need to be considered.",
      items: [
        "Electrical machinery",
        "Electronic products",
        "Industrial electrical equipment",
        "Control panels",
        "Laboratory and power equipment",
        "Industrial electronics and consumer electrical products"
      ],
      link: "Check my electrical product"
    },
    medical: {
      tab: "tab-medical",
      ...
      text: "CE regulatory support for manufacturers of applicable medical devices and in-vitro diagnostic products, including pathway assessment, classification, standards, risk management, technical documentation and Notified Body coordination where required.",
      items: [
      ...
      link: "Discuss my medical device"
    },
    pressure: {
      tab: "tab-pressure",
      ...
      text: "Support for pressure vessels, boilers, industrial piping, pressure accessories, pressure assemblies, heat exchangers and industrial pressure equipment. The applicable conformity-assessment pathway depends on product characteristics and regulatory classification.",
      items: [
        "Pressure vessels",
        "Boilers",
        "Industrial piping",
        "Pressure accessories and assemblies",
        "Heat exchangers",
    ...
    ppe: {
      ...
      text: "Support for applicable PPE products including protective clothing, safety equipment, industrial protective products and personal safety products — covering classification, testing, standards, technical documentation and conformity assessment.",
      items: [
        "Protective clothing",
        "Safety equipment",
        "Industrial protective products",
        "Personal safety products",
        "Standards identification and testing",
    ...
    radio: {
      ...
      text: "CE compliance support for wireless devices, IoT products, radio equipment, Bluetooth-enabled products, Wi-Fi devices, connected equipment, telecom equipment and wireless industrial controllers.",
      items: [
        "Wireless devices and IoT products",
        "Radio equipment",
        "Bluetooth-enabled products",
        "Wi-Fi devices",
        "Connected and telecom equipment",
    ...
    construction: {
      ...
      image: "assets/mumbai-corridor.webp",
      ...
      text: "Support for applicable construction products requiring assessment against relevant European requirements, including regulatory applicability review, standards identification, testing coordination, performance documentation, technical documentation and product-labelling review.",
      items: [
    ...
    other: {
      ...
      text: "Send us the product name, product image, datasheet and intended use and we can review the basic product information to identify the likely CE compliance pathway.",
      items: [
        "Product name + photograph",
        "Technical datasheet",
        "Intended use",
        "Existing test reports if available",
        "Model variants",
        "Target European market"
      ],
      link: "Check my product category"
    }
  };
    ...
    form.addEventListener("submit", async (event) => {
      ...
      const payload = {
        form: {
          ...
          models: form.querySelector("#models")?.value?.trim() || "",
